...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/accounts/login/
     - email, password  
     - POST
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/accounts/user_details/
     -   
     - GET
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/accounts/token/refresh/
     - refresh
     - POST
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/owned/phone_numbers
     - 
     - GET
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/phone_numbers
     - 
     - GET
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns
     -   
     - GET
...
.. list-table:: 
   ...
   * - URL
     ...
     - Other Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/<campaign_id>/update
     - Campaign ID
...
https://iris-app.techrida.com/api/system/campaigns/10/update/
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/<campaign_id>/delete
     - Campaign ID
     - DEL
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/<campaign_id>/details
     - Campaign ID
     - GET
...
.. list-table:: 
   ...
   * - URL
     ...
     - Other Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/test/voice/
     - message
     - voice_input
     - POST
...
.. list-table:: 
   ...
   * - URL
     ...
     - Other Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/<campaign_id>/begin/
     - message or aud_file
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/number/<campaign_id>
     - Campaign ID
     - GET
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/campaigns/number/<number_id>/delete/
     - Number ID
     - DEL 
...
.. list-table:: 
   ...
   * - URL
     - Required Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/number/<number_id>/
     - Number ID
     - GET
...
.. list-table:: 
   ...
   * - URL
     ...
     - Other Values
     - HTTP Methods
   * - https://iris-app.techrida.com/api/system/send/otp/
